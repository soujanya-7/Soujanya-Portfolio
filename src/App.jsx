        ...
        <div className="container">
          ...
          {(() => {
            const CERTS = [
              ...
              { icon: Code,        title: 'Programming with Java',                                  issuer: 'NPTEL',               year: '2025', color: '#f89820', filename: 'cert_java_nptel.jpg', credentialUrl: 'https://drive.google.com/file/d/1VuVZQjMqTeRa-HlfBKHqQrxq9AKuTw7_/view', skills: ['OOPs', 'Java SE', 'Multithreading', 'Data Structures'] },
